...
public class BoutiquesRecyclerAdapterLandscape extends RecyclerView.Adapter<BoutiquesRecyclerAdapterLandscape.MyViewHolder> {
    ...
    public BoutiquesRecyclerAdapterLandscape(ArrayList<IndividualArticle> mData, Context mContext) {
        this.myData = mData;
        this.mContext = mContext;
    }

    @Override
    public BoutiquesRecyclerAdapterLandscape.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LinearLayout v = (LinearLayout) LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shop_article_model, parent, false);
        GridLayoutManager.LayoutParams lp = (GridLayoutManager.LayoutParams) v.getLayoutParams();
        lp.width = parent.getWidth() / 2;
       BoutiquesRecyclerAdapterLandscape.MyViewHolder vh = new BoutiquesRecyclerAdapterLandscape.MyViewHolder(v);
        return vh;
    }
